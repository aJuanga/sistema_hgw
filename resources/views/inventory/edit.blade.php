                ...
                <form action="{{ route('inventory.update', $inventory) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" id="product_name" value="{{ $inventory->product->name }}" readonly
                        ...
                        <div>
                            ...
                            <input type="number" name="current_stock" id="current_stock" value="{{ old('current_stock', $inventory->current_stock) }}" min="0" step="0.01"
                        ...
                        <div>
                            ...
                            <input type="number" name="minimum_stock" id="minimum_stock" value="{{ old('minimum_stock', $inventory->minimum_stock) }}" min="0" step="0.01"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            @error('minimum_stock')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="number" name="maximum_stock" id="maximum_stock" value="{{ old('maximum_stock', $inventory->maximum_stock) }}" min="0" step="0.01"
                        ...
                        <div>
                            ...
                            <input type="text" name="unit" id="unit" value="{{ old('unit', $inventory->unit) }}" placeholder="unidad, kg, litros"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            @error('unit')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="date" name="last_restock_date" id="last_restock_date" value="{{ old('last_restock_date', $inventory->last_restock_date) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
