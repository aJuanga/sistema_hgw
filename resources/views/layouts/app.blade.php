        ...
        <div class="min-h-screen">
            ...
            >
                ...
                <div class="flex items-center justify-between h-16 px-6 border-b border-emerald-700 bg-emerald-950/50">
                    <a href="{{ route('dashboard') }}" class="flex items-center">
                        ...
                        <span class="ml-3 text-lg font-bold text-white">HGW Sistema</span>
                    </a>
                ...
                <div class="px-6 py-4 border-b border-emerald-700 bg-emerald-950/30">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-xs text-emerald-200">{{ ucfirst($user->role ?? 'Usuario') }}</p>
                        </div>
                    </div>
                </div>
                ...
                <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                    <a href="{{ route('dashboard') }}"
                       class="flex items-center px-4 py-3 text-sm font-medium rounded-xl transition {{ request()->routeIs('dashboard') ? 'bg-emerald-700 text-white shadow-lg' : 'text-emerald-100 hover:bg-emerald-800' }}">
            ...
            <div class="lg:pl-64">
                ...
                <div class="sticky top-0 z-30 flex items-center h-16 px-4 bg-white border-b border-gray-200 lg:hidden shadow-sm">
                    ...
                    <span class="ml-4 text-lg font-bold bg-gradient-to-r from-emerald-600 to-amber-600 bg-clip-text text-transparent">Sistema HGW</span>
                </div>
